class GetSymbolSummearyTradesObject {
  String exchange;
 ...
 factory GetSymbolSummearyTradesObject.fromJson(Map<String, dynamic> json) =>GetSymbolSummearyTradesObject(
