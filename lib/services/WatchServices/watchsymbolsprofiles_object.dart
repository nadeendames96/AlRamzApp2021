class WatchesSymbolsListProfilesObject {
  Null accumlossFlags;
  String avgPrice;
  String bidPrice;
  String bidVolume;
  ...
  String wk52Low;
  String wk52Range;
  WatchesSymbolsListProfilesObject.cons(this.updateDateTime,this.bidPrice);

  WatchesSymbolsListProfilesObject(
      {this.accumlossFlags,
        this.avgPrice,
        this.bidPrice,
        this.bidVolume,
   ...
   factory WatchesSymbolsListProfilesObject.fromJson(Map<String, dynamic> json) =>WatchesSymbolsListProfilesObject(
